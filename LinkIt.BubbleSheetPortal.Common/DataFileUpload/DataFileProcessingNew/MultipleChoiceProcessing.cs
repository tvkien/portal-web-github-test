    ...
    internal class MultipleChoiceProcessing
    {
        ...
        {            
            ...
            {               
                ...
                if (DataFileProcessing.CheckMultiSelect(assessmentItemTag, ref resource))
                {
                ...
                SetResponseDeclarationNode(ref assessmentItemTag, correctResponse, resource.QtiSchemaID);
                ...
                result = DataFileProcessing.CreateMainBodyTag(ref assessmentItemTag);
                if (!string.IsNullOrWhiteSpace(result))
                {
                    resource.Error = string.Format("There was some error when processing \"{0}\": {1} ", resource.ResourceFileName, result);
                    return resource;
        ...
        private static void SetResponseDeclarationNode(ref XmlNode assessmentItemTag, string correctResponse, int qtiSchemaId)
        {
