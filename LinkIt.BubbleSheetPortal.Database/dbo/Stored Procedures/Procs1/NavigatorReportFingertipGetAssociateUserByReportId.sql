...
(
    SELECT 1
    FROM sys.procedures
    WHERE Name = 'NavigatorReportFingertipGetAssociateUserByReportId'
)
    BEGIN
        DROP PROCEDURE [dbo].[NavigatorReportFingertipGetAssociateUserByReportId];
END;
GO
CREATE PROCEDURE [dbo].[NavigatorReportFingertipGetAssociateUserByReportId]
    ...
    BEGIN
        ...
        (
            ...
            (
                ...
                WHERE de.NavigatorReportID = @NavigatorReportId
            )
