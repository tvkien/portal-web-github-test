...
{
    public class VirtualTestCustomSubScore
    {
            ...
            get
            {
                ...
                if (UseRaw)
                {
                    scoreTypeList.Add(new ScoreTypeModel()
                    {
                        ...
                        SubscoreId = VirtualTestCustomSubScoreId,
        ...
        public bool IsSubscoreScoreTypeExisting(ScoreTypeModel scoreType)
        {
            return
                ScoreTypeList.Any(
                    x =>
        ...
        public VirtualTestCustomMetaData AddScoreTypeToSubScore(ScoreTypeModel scoreType)
        {
            if (!scoreType.SubscoreId.HasValue)
            {
                throw new Exception(string.Format("{0} is belong to a Template, unable to add it to a Subscore.",
                    scoreType.ScoreNameAbsolute));
            }
            ...
            if (!IsSubscoreScoreTypeExisting(scoreType))
            {
        ...
        public VirtualTestCustomMetaData AddScoreTypeNoteToSubScore(ScoreTypeModel scoreType, VirtualTestCustomMetaData noteMetaData, int lastedOrder)
        {
            ...
            {
                noteMetaData = new VirtualTestCustomMetaData()
                {
                    VirtualTestCustomScoreID = VirtualTestCustomScoreId,
                    VirtualTestCustomSubScoreID = VirtualTestCustomSubScoreId
                };
        ...
        public void DeleteScoreTypeFromSubScore(string scoreTypeName)
        {
        ...
        public bool HasCustomScoreType { get; set; }
