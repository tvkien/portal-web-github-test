...
namespace LinkIt.BubbleSheetPortal.Models.TLDS
{
    public class TLDSProfile
    {
        ...
        public bool? Section102IsNotRequired { get; set; } = true;
        ...
        public bool Section102Required { get { return Section102IsNotRequired.HasValue && !Section102IsNotRequired.Value; } }
    }
}
