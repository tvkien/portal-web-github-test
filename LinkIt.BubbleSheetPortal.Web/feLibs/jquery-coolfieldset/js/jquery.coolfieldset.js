...
; (function ($, window, undefined) {
  ...
  $.fn.coolfieldset = function (options) {
    var setting = { collapsed: false, animation: false, speed: 'medium' };
    ...
    return this.each(function () {
      ...
      var content = fieldset.children("*:not('legend,.wrapper')")
      ...
      legend.unbind("click").bind("click", function () { doToggle(fieldset, setting) });
