...
namespace LinkIt.BubbleSheetPortal.Web.ViewModels
{
    public class TestSettingsViewModel
    {
        ...
        [XmlElement(ElementName = "requireHonorCode")]
        public string RequireHonorCode { get; set; }

        [XmlElement(ElementName = "testExtractExportRawScore")]
        public string TestExtractExportRawScore { get; set; }
        ...
        [XmlElement(ElementName = "browserLockdownMode")]
        public string BrowserLockdownMode { get; set; }
        ...
        [XmlElement(ElementName = "timeLimitDurationType")]
        public int TimeLimitDurationType { get; set; }
        ...
        public TestSettingsViewModel()
        {
            ...
            ShuffleAnswers = string.Empty;
            AutoAdvanceTest = string.Empty;
            RequireHonorCode = string.Empty;
            TestExtractExportRawScore = string.Empty;
            ...
            BrowserLockdownMode = string.Empty;
