...
{
    public class ACTBubbleSheetStudentDetailsViewModel
    {
        ...
        public ACTBubbleSheetStudentDetailsViewModel()
        {
        ...
        public bool IsRemoveZeroPointForEssay { get; set; }
    }

    public class ACTResultDateModel
    {
        public string Property { get; set; } //M1, M2, D1, D2, Y1, Y2, Y3, Y4
