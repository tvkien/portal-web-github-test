...
{
    public class ACTReportOldController : BaseController
    {
        ...
        public ACTReportOldController(ACTReportService actReportService, UserService userService,
        ...
        //public ActionResult ReportPrintingMultipleStudents(string studentIDs, int districtID, int testID, int teacherID, int generatedUserID, int reportContentOption)
        //{
        ...
        //    {
        //        var masterModel = BuildReportMasterModel(studentID, districtID, testID, teacherID, generatedUserID, reportContentOption, false);
        ...
        private byte[] PrintOneFileV2(List<int> listStudentIDs, int districtId, int testID, int teacherID, int timezoneOffset, int reportContentOption, bool useNewACTStudentFormat, out string reportUrl)
        {
            ...
            for (int index = 0; index < listStudentIDs.Count; index++)
            {
                ...
                var url = Url.Action("ReportPrinting", "ACTReportOld",
                    new
                    {
                        studentID,
        ...
        private byte[] ExportToPDF(string url, int timezoneOffset, int studentID)
        {
            ...
            string footerUrl = Url.Action("RenderFooter", "ACTReportOld",
                new
                {
            ...
            string headerUrl = Url.Action("RenderHeader", "ACTReportOld", null, HelperExtensions.GetHTTPProtocal(Request));
        ...
        private string CreateNewACTFileAndUploadToS3(NewACTReportData model, List<ReportFileResultModel> reportFileResultModels)
        {
            ...
            var s3Url = s3Service.GetPublicUrl(bucketName, folder + "/" + model.ActReportFileName);
        ...
        //[CacheControl(HttpCacheability.NoCache), HttpGet]
        //[AjaxAwareAuthorize]
        //public ActionResult ACTGetClasses(int termId, int? userId, int virtualTestId)
        //{
        ...
        {
            var virtualTestIds = virtualTestIdString.ToIntList(",");
