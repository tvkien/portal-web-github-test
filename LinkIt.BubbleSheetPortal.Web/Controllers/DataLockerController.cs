...
namespace LinkIt.BubbleSheetPortal.Web.Controllers
{
    ...
    [AjaxAwareAuthorize]
    [VersionFilter]
    public class DataLockerController : BaseController
    {
        private readonly DataLockerControllerParameters _parameters;

        public DataLockerController(DataLockerControllerParameters parameters)
        {
        ...
        public ActionResult LoadCreateOverallScore(int templateId, int? subscoreId)
        {
            ...
            {
                fileType = _parameters.ConfigurationService.GetConfigurationByKeyWithDefaultValue("DataLocker_ArtifactFileType", "pdf");
            }
        ...
        public ActionResult ViewTemplate(int templateId)
        {
            ...
            if (model == null)
            {
                return RedirectToAction("Index", "DataLocker");
            }
        ...
        private bool HasImDataPointAssigned(int templateId, string scoreName = null, string subscoreName = null)
        {
            ...
            return _parameters.ReportingHttpClient.Get<bool>(url);
        }
    }
}
