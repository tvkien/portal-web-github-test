...
CKEDITOR.dialog.add( 'cellProperties', function( editor ) {
	...
	return {
		...
		minWidth: CKEDITOR.env.ie && CKEDITOR.env.quirks ? 170 : 150,
		minHeight: CKEDITOR.env.ie && ( CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks ) ? 90 : 70,
		contents: [
			{
			id: 'info',
				...
				children: [
					...
					children: [
						...
						children: [
							...
							labelStyle: 'display: inline-block; margin-right: 10px;float: left;',
