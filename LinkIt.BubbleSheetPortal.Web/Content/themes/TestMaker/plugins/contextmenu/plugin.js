				...
				addTarget: function( element, nativeContextMenuOnCtrl ) {
				    element.on('contextmenu', function (event) {
						...
						CKEDITOR.tools.setTimeout( function() {
                            ...
                            //switch hide table properties menu context and table hotspot properties
							var $iframes = $('iframe.cke_panel_frame').contents().find('body');
							if ($(event.data.getTarget().$.parentElement).parents('table').hasClass('tableHotspotInteraction')) {
							    $iframes.find('.cke_menubutton__table').hide().end()
							            .find('.cke_menubutton__cut').hide().end()
							            .find('.cke_menubutton__copy').hide().end()
							            .find('.cke_menubutton__tabledelete').hide();
							} else {
							    $iframes.find('.cke_menubutton__tablehotspot').hide().end()
							            .find('.cke_menubutton__gardingHotSpot').hide().end()
							            .find('.cke_menubutton__styleHotSpot').hide().end()
							            .find('.cke_menubutton__tablehotspotdelete').hide().end()
							            .find('.cke_menubutton__deletecellhotspot').hide().end()
							            .find('.cke_menubutton__cellhotspot').hide();							    
