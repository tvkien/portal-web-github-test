				...
				children: [
					...
					children: [
						...
						validate: function() {
							...
							if ( ( /javascript\:/ ).test( this.getValue() ) ) {
								customAlert( commonLang.invalidValue );
								return false;
							}
					...
					},
                    {
                        ...
                        children: [
                            {
                                type: 'html',
                                html: '<span class="warning_linkit">Note: We are not responsible for the contents, reliability or security of <br />the link you are inserting.</span>'
                            }
                        ]
                    },
					{
