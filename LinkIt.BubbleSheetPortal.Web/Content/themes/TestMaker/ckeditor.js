 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license Version: CKEditor 4.3.1 
 */
...
window.CKE_VERSION = window.CKE_VERSION || '';
...
if ( CKEDITOR.loader )
	...
	if ( document.body && ( !document.readyState || document.readyState == 'complete' ) ) {
		...
		script.src = CKEDITOR.getUrl('/Content/themes/TestMaker/core/loader.js') + window.CKE_VERSION;
		document.body.appendChild( script );
	} else {
	    document.write('<script type="text/javascript" src="' + CKEDITOR.getUrl('/Content/themes/TestMaker/core/loader.js') + window.CKE_VERSION + '"></script>');
	}
}
