...
(function() {
	var cssLoaded = {};
	// this variable will be deleted after coding done
	var check = [
		"justify_icons_justifyleft.svg",
		"justify_icons_justifycenter.svg",
		"justify_icons_justifyright.svg",
		"list_icons_numberedlist.svg",
		"list_icons_bulletedlist.svg",
		"basicstyles_icons_bold.svg",
		"basicstyles_icons_italic.svg",
		"basicstyles_icons_underline.svg",
		"basicstyles_icons_sameline.svg",
		"basicstyles_icons_subscript.svg",
		"basicstyles_icons_superscript.svg",
		"removeformat_icons_removeformat.svg",
		"link_icons_link.svg",
		"link_icons_unlink.svg",
		"table_icons_table.svg",
		"audioupload_icons_audio.svg",
		"imageupload_icons_image.svg",
		"video_icons_icon.svg",
		"specialchar_icons_specialchar.svg",
		"mathjax_icons_mathjax.svg",
		"glossary_icons_glossary.svg",
		"indent_icons_indent.svg",
		"indent_icons_outdent.svg",
		"tabspaces_icons_tabspaces.svg",
		"texttospeech_icons_texttospeech.svg",
		"mathfraction_icons_mathfraction.svg",
		"reference_icons_reference.svg",
		"leaui_formula_icons_icon.svg",
		"itemtypeonimage_icons_itemtypeonimage.svg"
	];
	...
	CKEDITOR.skin = {
		...
		getIconStyle: function( name, rtl, overridePath, overrideOffset, overrideBgsize ) {
			...
			path = CKEDITOR.getUrl( path );
			if (IS_V2 && path.startsWith(CKEDITOR.basePath + 'plugins/')) {
				var tempPath = path
					.replace(CKEDITOR.basePath + 'plugins/', '')
					.split('/')
					.join('_')
					.replace('.png', '.svg');
				if (check.includes(tempPath)) {
					path = CKEDITOR.basePath + 'v2/' + tempPath + window.CKE_VERSION;
				}
			}
			return path &&
				( 'background-image:url(' + path + ');background-position:0 ' + offset + 'px;background-size:' + bgsize + ';' );
		}
	};
