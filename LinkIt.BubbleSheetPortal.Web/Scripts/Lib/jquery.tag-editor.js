...
(function ($) {
  ...
  $.fn.tagEditor = function (options, val, blur, className ) {
    ...
    if (typeof options == 'string') {
      ...
      selector.each(function () {
        ...
        if (options == 'getTags'){
          ...
          // insert new tag
          if (o.visibleIconDelete) {
            $('<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag ' + className + '"></div><div class="tag-editor-delete"><i></i></div></li>').appendTo(ed).find('.tag-editor-tag')
            .html('<input type="text" maxlength="' + o.maxLength + '">').addClass('active').find('input').val(val).blur();
          } else {
            $('<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag ' + className + '"></div><i></i></li>').appendTo(ed).find('.tag-editor-tag')
            .html('<input type="text" maxlength="' + o.maxLength + '">').addClass('active').find('input').val(val).blur();
          }
          if (!blur) ed.click();
          $('.placeholder', ed).remove();
        } else if (options == 'addValue') {
          if (o.maxTags && ed.data('tags').length >= o.maxTags) return false;

          var lastTag = $('.tag-editor li:last-child .tag-editor-tag');
          if (lastTag.hasClass('arithmetic-tag')) {
            $('.tag-editor .arithmetic-tag:last').click(); 
            var input = lastTag.find('input');
            ...
            var $li = $('<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag ' + className + '"></div><div class="tag-editor-delete"><i></i></div></li>').appendTo(ed);
              var $input = $li.find('.tag-editor-tag')
    ...
    return selector.each(function () {
      ...
      if (o.visibleIconDelete) {
        ...
        var new_tag = '<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag"></div><i></i></li>';
      }
      ...
      function split_cleanup(input) {
        ...
        for (var i = 0; i < sub_tags.length; i++) {
          ...
          if (o.visibleIconDelete) {  
            ...
            li.before('<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag">' + escape(tag) + '</div><i></i></li>');
          }
      ...
      for (var i = 0; i < tags.length; i++) {
        ...
        if (tag) {
          ...
          if (o.visibleIconDelete) {
            ...
            ed.append('<li><div class="tag-editor-spacer">&nbsp;' + o.delimiter[0] + '</div><div class="tag-editor-tag">' + escape(tag) + '</div><i></i></li>');
          }
        }
      }
