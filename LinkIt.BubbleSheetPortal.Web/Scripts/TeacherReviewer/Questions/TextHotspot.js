(function ($) {
    $.widget('jquery.TextHotspot', {
        ...
        Display: function (self, question) {
            ...
            var answerText = '';
            if (!options.TextHotspotUtil.IsNullOrEmpty(answerOfStudentForSelectedQuestion)) {
            ...
            var mark = $('');
            if (!options.TextHotspotUtil.IsNullOrEmpty(self.QTIOnlineTestSessionID()) && (self.IsComplete() || self.IsPendingReview())) {
