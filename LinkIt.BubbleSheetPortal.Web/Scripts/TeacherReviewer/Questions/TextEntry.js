    ...
    $.widget('jquery.TextEntry', {
        ...
        Display: function (self, question) {
            ...
            if (!Reviewer.IsNullOrEmpty(testOnlineSessionAnswer)) {
                responseProcessingTypeID = testOnlineSessionAnswer.ResponseProcessingTypeID();
                selectedAnswer = testOnlineSessionAnswer.AnswerText();
                ...
                self.ResponseProcessingTypeID(testOnlineSessionAnswer.ResponseProcessingTypeID());
