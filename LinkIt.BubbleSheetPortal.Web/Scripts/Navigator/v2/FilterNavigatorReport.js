...
var filterNavigatorReportApp = new Vue({
  ...
  computed: {
    ...
    selectedItemIconClasses: function () {
      return {
        'icon': true,
        'icon_folder_custom_large': (this.selectedIdentifier.documentType.toLowerCase() == 'folder'),
      ...
      $.ajax({
        ...
        success: function (result, status, xhr) {
          ...
          if (result.status && result.status.toLowerCase() == 'error' || !result.strongData) {
            ...
            var message = totalPublishedReports + " reports have been published successfully"
            customAlert(message);
          }
