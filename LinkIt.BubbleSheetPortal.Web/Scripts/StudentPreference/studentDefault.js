...
var template =
  ...
  <legend v-show="!isShowTestTypes">Select Options Level </legend> \
  <div v-show="!isShowTestTypes" style="float:none" class="fileter-item"> \
    <label>Level</label> \
  ...
  <legend v-show="isShowTestTypes">Select Test Type </legend> \
    <div v-show="isShowTestTypes" class="fileter-item"> \
      <label>Level</label> \
  ...
  <div v-if="showSelectDistrict" class="fileter-item"> \
    ...
    <select id="selectedDistrictID" v-model="disrtrictsDefault" v-on:change="selectDistrict"  class="full-width"> \
  ...
  <div v-if="showSelectSchool" class="fileter-item"> \
    <label>School</label> \
    <select  id="selectedSchoolID" v-model="schoolsDefault"  class="full-width"> \
