 ...
 * @see {@link https://github.com/muaz-khan/RecordRTC|RecordRTC Source Code}
 */
function invokeSaveAsDialog(file, fileName, multipleDots = false) {
    if (!file) {
    ...
    if (fileName && fileName.indexOf('.') !== -1) {
      if (!multipleDots) {
        ...
        var lastIndex = rawName.lastIndexOf(".");
        fileName = rawName.substring(0, lastIndex);
        fileExtension = rawName.substring(lastIndex + 1);
      }
    }
