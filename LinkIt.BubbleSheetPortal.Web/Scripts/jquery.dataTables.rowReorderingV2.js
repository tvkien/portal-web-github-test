...
(function ($) {
    ...
    $.fn.rowReordering = function (options) {
        ...
        function _fnStartProcessingMode(oTable) {
            ...
            if (properties.idToMaskLoading != null && properties.idToMaskLoading != '') {
                ShowBlock($('#' + properties.idToMaskLoading), 'Loading');
            }
        }
        ...
        function _fnEndProcessingMode(oTable) {
            ...
            if (properties.idToMaskLoading != null && properties.idToMaskLoading != '') {
                $('#' + properties.idToMaskLoading).unblock();
            }
        }
        ...
        return this.each(function () {
            ...
            $("tbody", oTable).sortable({
                ...
                update: function (event, ui) {
                    ...
                    var oState = fnGetState($dataTable, sSelector, ui.item.attr('id'));
                    ...
                    if (properties.sURL != null) {
						...
						var oAjaxRequest = {
                            ...
                            success: function (data) {
                                ...
                                fnMoveRows($dataTable, sSelector, oState.iCurrentPosition, oState.iNewPosition, oState.sDirection, ui.item.attr('id'), sGroup);
