                ...
                .replaceWith(function () {
                    ...
                    newChoiceInteraction.find('simpleChoice').replaceWith(function () {
                        ...
                        if (simpleChoice.find('div[typemessage]').length) {
                            ...
                            var iconString = '<img identifier="' + simpleChoiceIdentifier + '" alt="Guidance" style="margin-left: 5px;" class="imageupload bntGuidance" src="../../Content/themes/TestMaker/images/guidance_checked_medium.png" title="">';
