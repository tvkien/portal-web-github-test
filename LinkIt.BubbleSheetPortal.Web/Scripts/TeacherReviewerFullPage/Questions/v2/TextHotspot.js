(function ($) {
    $.widget('jquery.TextHotspot', {
        ...
        Display: function (question) {
            ...
            answerHtml = that.GetContentTextHotspot(self, $(question.ItemBody()), mappingsAnswer, mappingsCorrect);
        ...
        GetContentTextHotspot: function (self, selector, mappings, mappingsCorrect) {
                        ...
                        if (mapping === sourceItemIdentifier) {
                            ...
                            if (mappingsCorrect != '' && mappingsCorrectArr.length > 0) {
                                if (mappingsCorrectArr.includes(mapping)) {
                                    $newSourceItem.addClass('correct-question');
                                } else {
                                    $newSourceItem.addClass('incorrect-question');
                                }
                            }
                        }
                    }
