(function ($) {
    $.widget('jquery.Numberline', {
        ...
        Display: function (question) {
            ...
            answerHtml = that.GetContentNumberLineHotspot(self, $(question.ItemBody()), mappingsAnswer, mappingsCorrect);
        ...
        GetContentNumberLineHotspot: function (self, selector, mappings, mappingsCorrect) {
