(function ($) {
    $.widget('jquery.ImgHotspot', {
        ...
        Display: function (question) {
            ...
            answerHtml = that.GetContentImgHotspot(self, $(question.ItemBody()), mappingsAnswer, mappingsCorrect);
        ...
        GetContentImgHotspot: function (self, selector, mappings, mappingsCorrect) {
            ...
            $selector.find('imageHotSpot').replaceWith(function() {
                ...
                $result.find('sourceItem').replaceWith(function() {
                    ...
                    if (mappings !== '') {
                        ...
                        var mappingsCorrectArr = mappingsCorrect.split(',');
                        ...
                        for (var i = 0, lenMapper = mapper.length; i < lenMapper; i++) {
                            ...
                            if (mapping === sourceItemIdentifier) {
                              ...
                              if (mappingsCorrect != '' && mappingsCorrectArr.length > 0) {
                                if (mappingsCorrectArr.includes(mapping)) {
                                  $newSourceItem.addClass('correct');
                                } else {
                                  $newSourceItem.addClass('incorrect');
                                }
                              }
                            }
                        }

                        if (mappingsCorrectArr.includes(sourceItemIdentifier)) {
                          $newSourceItem.addClass('answerQuestion');
                        }
                    }
