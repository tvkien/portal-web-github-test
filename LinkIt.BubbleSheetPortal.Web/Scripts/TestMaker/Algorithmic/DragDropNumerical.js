var DragDropNumericalAlgorithmic = (function () {
    ...
    function getFilters (xmlContent) {
        ...
        $container.find('responseDeclaration').each(function () {
            var $dragdropnumerical = $(this);
            var dragdropnumericalResponseId = $dragdropnumerical.attr('identifier');
            var arrSourceValues = [];
            var arrDestValues = [];
            ...
            filters.push({
                id: dragdropnumericalResponseId,
                label: dragdropnumericalResponseId,
                type: 'string',
